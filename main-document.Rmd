...
There are a few different strategies we think could be useful for
gathering

[paragraph about evidence-based measurement of bio sex]

Given that transgender male-to-female and female-to-male both choose
male sex and female sex in response to each of the sex questions, we
suggest that BRFSS interviewers ask all of the questions currently asked
of only male sex or only female sex for any person who identifies as
transgender. In this way we can ensure we have accurate information
about important cancer screenings, health conditions, and health
behaviors among transgender people. Computed variables like
classification as heavy drinking and binge drinking we would suggest
