...
BRFSS_all <- rbind(select(BRFSS_2015, SEX, TRNSGNDR), 
                   select(BRFSS_2016, SEX, TRNSGNDR),
                   select(BRFSS_2017, SEX, TRNSGNDR),
                   select(BRFSS_2018, SEX, TRNSGNDR),
                   select(BRFSS_2019, SEX, TRNSGNDR))
...
table(trans = BRFSS_all_clean$TRNSGNDR, sex = BRFSS_all_clean$SEX)
