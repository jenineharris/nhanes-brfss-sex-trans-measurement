...
research question (Bauer). For example, surveys might erroneously
...
| K 1  |                                             |      |      |
+------+---------------------------------------------+------+------+
| \    | Binge drinkers (males having five or more   | c o  | 20   |
| \_ R | drinks on one occasion, females having four | m p  | 15 , |
| F B  | or more drinks on one occasion)             | u t  | 20   |
| I N  |                                             | e d  | 18   |
| G 5  |                                             |      |      |
+------+---------------------------------------------+------+------+
| \    | Heavy drinkers (adult men having more than  | c o  | 2 01 |
| \_ R | 14 drinks per week and adult women having   | m p  | 5, 2 |
| F D  | more than 7 drinks per week)                | u t  | 01   |
| R H  |                                             | e d  | 6,   |
| V 5  |                                             |      | 20   |
|      |                                             |      | 17   |
+------+---------------------------------------------+------+------+
| \    | Heavy drinkers (adult men having more than  | c o  | 20   |
| \_ R | 14 drinks per week and adult women having   | m p  | 18   |
| F D  | more than 7 drinks per week)                | u t  |      |
| R H  |                                             | e d  |      |
| V 6  |                                             |      |      |
+------+---------------------------------------------+------+------+
