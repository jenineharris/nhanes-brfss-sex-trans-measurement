...
BRFSS_all_clean <- BRFSS_all %>% 
  ...
  mutate(yearLong = recode_factor(year,
                              ...
                              '2017' = '2017: Indicate sex of respondent. Or, Are you male or female?',
