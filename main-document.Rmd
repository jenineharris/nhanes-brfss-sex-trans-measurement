...
Similar inadequate data in medical records is exacerbating the problem.
For example, although most transgender men still have a cervix, they are
less likely to be screened for cervical cancer compared to their
cisgender counterparts [@gatos2018] with one of the reasons being that
some health systems base screening invitations on the sex listed health
records [@connolly2020]. It is clear that our existing tools at multiple
levels are inadequate for collecting and using data effectively for
transgender people.
...
the two-step questions provide more detailed information and is
preferable, it is not perfect. Numerous studies suggest there are some
drawbacks including a small number of people not identifying as
...
A 2017 study [@Bauer2017] examined different ways of measuring sex and
gender and consulted with experts to identify a set of three questions,
...
of transgender people. More accurate, inclusive, and consistent
measurement along with data systems that are more flexible for data
collection, storage, and use are strategies that may help to address
this problem.
