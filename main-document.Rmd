...
The Behavioral Risk Factor Surveillance Survey (BRFSS) collects data on risk behaviors, health conditions, and the use of health-related services from U.S residents via telephone. It is considered the world's largest health survey system, collecting data from over 400,000 yearly. add cite: (<https://www.cdc.gov/brfss/about/index.htm>).  
